...
/**
 * Inbound adapter: consumes messages that exhausted all retries and were
 * routed to the dead-letter topic by {@code KafkaConfig#kafkaErrorHandler}.
 * <p>
 * Logs structured details from the DLT headers added by
 * {@link org.springframework.kafka.listener.DeadLetterPublishingRecoverer}
 * so failed messages are visible in monitoring without losing context.
 */
@Component
