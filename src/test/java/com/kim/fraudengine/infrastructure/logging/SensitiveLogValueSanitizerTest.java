...
class SensitiveLogValueSanitizerTest {
    ...
    void sanitizePathRedactsUuidAndIdentifierSegments() {
        String sanitized = SensitiveLogValueSanitizer.sanitizePath(
    ...
    void sanitizePathRedactsCaseInsensitiveIdentifierSegmentsWithSuffixes() {
        String sanitized = SensitiveLogValueSanitizer.sanitizePath("/users/CUSTOMER-AB12_extra/profile");
    ...
    void sanitizePathLeavesSegmentsThatDoNotMatchIdentifierShape() {
        String sanitized = SensitiveLogValueSanitizer.sanitizePath("/reports/acct_team_ab12/q1_summary_2024");
