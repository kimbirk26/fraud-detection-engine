...
class ResponseRecordDefensiveCopyTest {
    ...
    void alertResponse_defensively_copies_triggered_rules() {
        ...
        triggeredRules.add(new AlertResponse.RuleResultResponse("RULE", SeverityResponse.HIGH, "reason"));
        ...
        assertThatThrownBy(() -> response.triggeredRules()
                .add(new AlertResponse.RuleResultResponse("OTHER", SeverityResponse.LOW, "other")))
    ...
    void errorResponse_defensively_copies_field_errors_when_present() {
        ...
        assertThatThrownBy(() -> response.fieldErrors()
                .add(new ErrorResponse.FieldError("amount", "must be positive")))
                .isInstanceOf(UnsupportedOperationException.class);
    }
}
